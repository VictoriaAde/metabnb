  ...
  return (
    ...
    >
      <div
        ...
        className="flex flex-col basis-5/12 white_bg rounded-2xl py-10 mt-20"
      >
        ...
        <div className="flex justify-between items-center border border-line rounded-xl bg-lightMilk py-3 mx-8 px-5 mb-4">
        ...
        <div className="flex justify-between items-center border border-line rounded-xl bg-lightMilk py-3 mx-8 px-5">
          <div className="flex items-center gap-4">
